...
RUN R -e "install.packages(c('acepack', 'assertthat', 'base64enc', 'BH', 'bitops', 'brglm', 'car', 'caTools', 'chron', 'classInt', 'colorspace', 'curl', 'data.table', 'DBI', 'devtools', 'dichromat', 'digest', 'docopt', 'dplyr', 'e1071', 'evaluate', 'forestplot', 'formatR', 'Formula', 'ggplot2', 'git2r', 'gridExtra', 'gtable', 'highr', 'Hmisc', 'htmltools', 'htmlwidgets', 'httpuv', 'httr', 'jsonlite', 'knitr', 'labeling', 'latticeExtra', 'lazyeval', 'leaflet', 'lme4', 'lubridate', 'magrittr', 'markdown', 'MatrixModels', 'memoise', 'mime', 'minqa', 'munsell', 'nloptr', 'openssl', 'pbkrtest', 'plyr', 'png', 'profileModel', 'quantreg', 'R6', 'raster', 'RColorBrewer', 'Rcpp', 'RcppEigen', 'reshape2', 'rmarkdown', 'saves', 'scales', 'shiny', 'shinyBS', 'shinyjs', 'sp', 'SparseM', 'stargazer', 'stringi', 'stringr', 'tidyr', 'whisker', 'withr', 'xtable', 'yaml', 'zoo'), repos='https://cran.rstudio.com/')"
